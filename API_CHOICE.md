...
- Risques (instabilité, downtime, CORS, etc.) : 
  ...
  - Parades de l'API : Risque de recevoir une valeur `null` pour l'âge si un prénom atypique est testé.
  - Instabilité : Risque de downtime temporaire classique pour une API publique.
